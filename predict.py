"""
load weights of classifier model and predict the probability of candidate materials.
...
import pandas as pd                 # Wu: NEW
from accelerate import Accelerator
from kogger import Logger

import config as cfg
from dataset import PredictCIFData   # WU: different than pretrain and train
...
def predict(accelerator, data_loader, model, logger, config):
    ...
    for batch_idx, (inputs, target, cif_id) in enumerate(data_loader):           # Wu: notice
